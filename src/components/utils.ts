...
const getFromList = (list: string[]) =>
	list[Math.floor(Math.random() * list.length)];

const randomCharacter = (character: string, characters: string | undefined) => {
	let randomChar = character;

	switch (characters) {
		case 'all':
			randomChar = getFromList([
				...capitalLetters,
				...lowerLetters,
				...numbers,
				...symbols,
...
// export { randomCharacter, hackerText }; Original implementation, could not find hackerText
